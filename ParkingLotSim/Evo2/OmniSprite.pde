class OmniSprite extends PixSprite{
  ...
  OmniSprite(int life, float sp, float x, float y, double v, float r, ArrayList<FoodSprite> food, ArrayList<PixSprite> pix){ //constuctor/////////////////////////////
    super(life, sp, x, y, v, r, food);
  ...
  void reproduce(){
   ...
   int findPix(ArrayList<PixSprite> arr){
  ...
  void chasePix(int i, ArrayList<PixSprite> arr){
